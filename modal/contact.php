...
$php_main_email = "fernando.ropero@uah.es";
...
if (filter_var($php_email, FILTER_VALIDATE_EMAIL)) {
		...
		$php_subject = "Message from the personal webpage";
		...
		. 'This is a Contact Confirmation mail. Please, do not respond to this mail.'
		. '<br/>'
		. '.</div>';
